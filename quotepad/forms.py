...
class FormStepSix_yh(forms.Form):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['fuel_supply_length'] = forms.MultipleChoiceField(choices=[(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Fuel Supply Length').order_by('-component_name').only('component_name')])
		self.fields['scaffolding_required'] = forms.ChoiceField(choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Scaffolding').order_by('-component_name').only('component_name')])
		...
		self.fields['asbestos_removal_procedure'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Asbestos Removal Procedure').order_by('brand').only('component_name')], widget=forms.Select(attrs={'disabled': 'disabled'}))
		#self.fields['electrical_work_required'] = forms.ChoiceField(choices=ELECTRICAL_WORK_REQUIRED_DROPDOWN)
		self.fields['electrical_work_required'] = forms.ChoiceField(choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Electrical Work').order_by('brand').only('component_name')])
		...
		self.fields['parking_requirements'] = forms.ChoiceField(choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Parking').order_by('brand').only('component_name')])
...
class FormStepSeven_yh(forms.Form):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['additional_central_heating_components'] = forms.MultipleChoiceField(choices=[(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Additional Central Heating Component').order_by('-component_name').only('component_name')])
		...
		self.fields['filling_link'] = forms.ChoiceField(choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Filling Link').order_by('-component_name').only('component_name')])
		...
		if self.boiler_type == 'Combi':
			...
			self.fields['cylinder'] = forms.ChoiceField(choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Cylinder').order_by('brand').only('component_name')])
...
class FormStepEight_yh(forms.Form):
	...
	def __init__(self, *args, **kwargs):
		...
		self.fields['location_1'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Location').order_by('brand').only('component_name')])
		self.fields['location_2'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Location').order_by('brand').only('component_name')])
		self.fields['location_3'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Location').order_by('brand').only('component_name')])
		self.fields['location_4'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Location').order_by('brand').only('component_name')])
		self.fields['location_5'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Location').order_by('brand').only('component_name')])
		self.fields['location_6'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Location').order_by('brand').only('component_name')])
		self.fields['location_7'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Location').order_by('brand').only('component_name')])
		self.fields['location_8'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Location').order_by('brand').only('component_name')])
		self.fields['location_9'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Location').order_by('brand').only('component_name')])
		self.fields['location_10'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Location').order_by('brand').only('component_name')])
		self.fields['location_11'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Location').order_by('brand').only('component_name')])
		self.fields['location_12'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Location').order_by('brand').only('component_name')])
		...
		self.fields['radiator_style_1'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Style').order_by('brand').only('component_name')])
		self.fields['radiator_style_2'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Style').order_by('brand').only('component_name')])
		self.fields['radiator_style_3'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Style').order_by('brand').only('component_name')])
		self.fields['radiator_style_4'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Style').order_by('brand').only('component_name')])
		self.fields['radiator_style_5'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Style').order_by('brand').only('component_name')])
		self.fields['radiator_style_6'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Style').order_by('brand').only('component_name')])
		self.fields['radiator_style_7'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Style').order_by('brand').only('component_name')])
		self.fields['radiator_style_8'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Style').order_by('brand').only('component_name')])
		self.fields['radiator_style_9'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Style').order_by('brand').only('component_name')])
		self.fields['radiator_style_10'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Style').order_by('brand').only('component_name')])
		self.fields['radiator_style_11'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Style').order_by('brand').only('component_name')])
		self.fields['radiator_style_12'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Radiator Style').order_by('brand').only('component_name')])
		...
		self.fields['towel_rail_location_1'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Towel Rail Location').order_by('brand').only('component_name')])
		self.fields['towel_rail_location_2'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Towel Rail Location').order_by('brand').only('component_name')])
		self.fields['towel_rail_location_3'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Towel Rail Location').order_by('brand').only('component_name')])
		self.fields['towel_rail_location_4'] = forms.ChoiceField(required = False, choices=[('','Select One')] + [(component.component_name,component.component_name) for component in ProductComponent.objects.filter(user = self.user, component_type = 'Towel Rail Location').order_by('brand').only('component_name')])
